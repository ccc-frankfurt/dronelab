...
class AutonomousDrone(object):
    ...
    def __init__(self, args):
        ...
        self.path_to_routecsv = args.csv  # '/home/pi/dronelab/routes/route_test.csv' # make configurable
...
def loadarguments():
    ...
    parser.add_argument('--log_level', dest='log_level', type=str,
                        ...
                        help='Log Level')
    parser.add_argument('--route', dest='csv', type=str,
                        default=None,
                        help='Define route *.csv for fixroute mode')
